...
async def check_or_set_log_channel():
    try:
        ...
        if al_log_channel:
            ...
            log_channel = await NEXAUB.create_channel(title="paige Userbot Logs", description="Logs of your paige Userbot")
            log_channel_id = log_channel.id
            await NEXAUB.set_chat_photo(chat_id=log_channel_id, photo="cache/paige2.jpg")
            welcome_to_nexaub = f"""
**Welcome to paige Userbot**
Thanks for trying paige Userbot. If you found any error, bug or even a Feature Request please report it at **@EngrJuanMala**
