...
async def pyroalive(_, message: Message):
    ...
    custom_alive_msg = get_alive_msg if get_alive_msg else "Heya, I'm Using paige Userbot"
    # Alive Pic
    g_al_pic = await get_custom_var(var="ALIVE_PIC")
    alive_pic = g_al_pic[1] if g_al_pic else "cache/paige2.jpg"
...
**✨ paige UserBot is Alive**
    
    **》 paige Userbot Version:** `{NEXAUB_VERSION}`
